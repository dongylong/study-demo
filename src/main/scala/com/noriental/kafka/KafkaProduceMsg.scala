...
//  private val DIR = "/local/data/kafka-msg"
//
//  /**
//    * 1、配置属性
...
//          }
//
//          //produce完成后，将文件copy到另一个目录，之后delete
//          val fileName = file.toFile.name
//          file.toFile.copyTo(Path("/local/data/kafka-msg/completed/" + fileName + ".completed"))
//          file.delete()
//        }
//      } catch {
